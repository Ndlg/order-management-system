...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--bind-code", help="Bind code generated by Web admin.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.bind_code:
        config = bind_with_code(config["server_url"], args.bind_code, args.machine_label or config.get("machine_label", ""))
